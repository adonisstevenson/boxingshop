                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="offerCategory" placeholder="np. Trening" name="offerCategory">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="offerSubCategory" placeholder="np. Rękawice" name="offerSubCategory">
                            </div>
                        </div>
                    </div>
                    <div class="row">
